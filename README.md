...
1. Create a new public GitHub repository, for example `temple`.
...
7. Your URLs will be:
   - Landing page: `https://<github-username>.github.io/temple/`
   - Privacy policy: `https://<github-username>.github.io/temple/privacy/`
   - Terms: `https://<github-username>.github.io/temple/terms/`

Replace `<github-username>` and `temple` with the actual account and repository names.

## Before App Store submission

- Replace `[your postal address]` in `privacy/`, `terms/`, and `contact/`.
